                        ...
                        <div class="resume__body">
                                ...
                                <div class="form__base_info">
                                    ...
                                    <div class="form__row flex top">
                                        ...
                                        <label class="form__item form__item--col4">
                                            ...
                                            <input class="form__input " type="text" name="phone" data-mask="+7 (000) 000-00-00" data-mask-clearifnotmatch="true" placeholder="+7 (___) ___-__-__">
                                            <span class="form__error">Поле заполнено некорректно</span>
                                        </label>
                                    </div>
                                    <!-- End form__row -->
                                    ...
                                    <div class="form__row flex top">
                                        ...
                                        <label class="form__item form__item--col4">
                                            ...
                                            <input class="form__input " type="text" name="birth" data-mask="00/00/0000" data-mask-clearifnotmatch="true" placeholder="дд/мм/гггг">
                                            <span class="form__error">Поле заполнено некорректно</span>
                                        </label>
                                    </div>
                                    <!-- End form__row -->
                            ...
                            <div class="form__row">
                                <label class="form__item">
                                    ...
                                    <input class="form__input " type="text" name="position">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                            </div>
                            <!-- End form__row -->
                        ...
                        <div class="resume__body">
                            ...
                            <div class="form__row">
                                <label class="form__item">
                                    ...
                                    <input class="form__input " type="text" name="university[]">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                            </div>
                            <!-- End form__row -->
                            ...
                            <div class="form__row flex top">
                                <label class="form__item form__item--col2">
                                    ...
                                    <input class="form__input " type="text" name="year_entry[]" data-mask="0000" data-mask-clearifnotmatch="true" placeholder="____">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                                <label class="form__item form__item--col2">
                                    <span class="form__label">Год окончания <span>*</span></span>
                                    <input class="form__input " type="text" name="year_ending[]" data-mask="0000" data-mask-clearifnotmatch="true" placeholder="____">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                                <label class="form__item form__item--col4">
                                    <span class="form__label">Академическая степень <span>*</span></span>
                                    <input class="form__input " type="text" name="academic_degree[]">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                            </div>
                            <!-- End form__row -->
                        ...
                        <div class="resume__body">
                            ...
                            <div class="form__row flex top">
                                <label class="form__item form__item--col2">
                                    ...
                                    <input class="form__input " type="text" name="started[]" data-mask="00/0000" data-mask-clearifnotmatch="true" placeholder="мм/гггг">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
                                <label class="form__item form__item--col2">
                                    <span class="form__label">Окончание работы <span>*</span></span>
                                    <input class="form__input " type="text" name="ending[]" data-mask="00/0000" data-mask-clearifnotmatch="true" placeholder="мм/гггг">
                                    <span class="form__error">Поле заполнено некорректно</span>
                                </label>
