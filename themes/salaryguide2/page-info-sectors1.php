...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
    ...
    <div class="trends">
        ...
        <div class="trends__select" style="background-color: white;">
            <div class="container flex top">
                <div class="trends__select_left">
                    <h2 style="color:#022675;">Что нового <span>на рынке труда?</span></h2>
                </div>
                <div class="trends__select_right">
                    <p class="trends__select_text" style="color:#022675;">Выберите интересующую отрасль, и мы расскажем об основных&nbsp;трендах.</p>
                    <!-- Begin form -->
                    <?php
                    $id = $_GET['sector']??0;
                    $id = (int)$id;
                    ...
                    <form class="trends__select_form form flex top" action="/info-sectors1/" method="get">
        ...
        <!-- End trends__select -->
        <!-- Begin trends__info -->
        <div class="trends__info" style="background-color:#022675;">
            <div class="container flex top">
                <div class="trends__info_left">
                    <h2 style="color:white;">Тренды</h2>
                    <img class="single_link__icon" src="https://salaryguide-preprod.hays.ru/wp-content/themes/salaryguide2/assets/img/salary/trend.svg" alt="" style="width: 150px; margin-top: 50px;">
                </div>
                <div class="trends__info_right text" style="color:white;">
    ...
    <div class="top_positions">
        <div class="container flex top">
            <div class="top_positions__title">
                ...
                <img class="single_link__icon" src="https://salaryguide-preprod.hays.ru/wp-content/themes/salaryguide2/assets/img/salary/top-three.svg" alt="" style="width: 150px; margin-top: 50px;">
            </div>
